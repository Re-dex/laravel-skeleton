...
## Uses
create a new repository using laravel-skeleton template
clone your newly created repository in your local machine then checkout specific branch which version of laravel you want to use.
